            ...
            <div className="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md m-4">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <select id="site-select" value={selectedSiteId} onChange={(e) => setSelectedSiteId(Number(e.target.value))} className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 rounded-md">
